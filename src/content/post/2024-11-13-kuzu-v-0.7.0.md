...
such as CSV, Parquet, or JSON, or in-memory objects, such as Pandas or Polars data frames, or the results of another subquery. 
...
examples on how CSV sniffer works.
...
We had originally added this feature to enable users to import and query their raw RDF data, e.g., a Turtle file, in Kùzu,
