...
Details of this feature can be found [here](https://kuzudb.com/docusaurus/cypher/query-clauses/call#read_pandas).
...
of this feature can be found [here](https://kuzudb.com/docusaurus/cypher/copy).

### Updates

#### Detach Delete

Kùzu now supports Cypher's [DETACH DELETE](https://kuzudb.com/docusaurus/cypher/data-manipulation-clauses/delete#detach-delete) clause,
...
Details of this feature can be found [here](https://kuzudb.com/docusaurus/cypher/data-manipulation-clauses/read-after-update).
...
Details of the `cast` function can be found [here](https://kuzudb.com/docusaurus/cypher/expressions/casting).
...
Details of this feature can be found [here](https://kuzudb.com/docusaurus/cypher/query-clauses/match#filter-variable-length-relationships).
...
```
The details of count subqueries can be found [here](https://kuzudb.com/docusaurus/cypher/subquery#count-subquery).
