...
search over your vector embeddings fully within Kuzu. Read about this and a host of other features and performance
...
we are releasing our vector index which 
...
because the connections in the index, which was constructed on all vectors and not just the give subset, 
...
Let us next give a sense of the performance you can expect from Kuzu's vector index.
...
their awesome work on this release. And our sincere thanks goes out to the Kuzu user community,
for all the bug reports and feature requests that make Kuzu better with each release! 
Please try out the new release and let us know what you think.
