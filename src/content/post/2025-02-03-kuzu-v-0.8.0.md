...
We're introducing an `fts` extension to enable full-text search capabilities using [BM25](https://en.wikipedia.org/wiki/Okapi_BM25) scoring algorithm in Kùzu.
