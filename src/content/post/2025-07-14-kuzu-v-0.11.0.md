...
You can learn more about the different on-disk files created and managed by Kuzu [here](https://docs.kuzudb.com/developer-guide/files/). (TODO: This link is broken. Maybe remove it if it's not necessary.)
