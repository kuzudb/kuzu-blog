...
## Vector Index
As there is a growing demand for vector similarity searches in databases, we are excited to announce our new [`VECTOR`](https://docs.kuzudb.com/extensions/vector/) extension, which allows you to perform similarity search over vector data in Kuzu.
