...
Each query is run 3 times, and we report the average.
We construct the index with **8 threads**, and query it with **1 thread**.

| Dataset | Dimension | Num tuples | Construction (s) | Search (ms) |
| --- | --- | --- | --- | --- |
...
Each query is run with a single thread only.

| Selectivity (%) | Search (ms) | Recall |
| --- | --- | --- |
| 1 | 16.7 | 1.00 |
| 3 | 16.4 | 1.00 |
| 5 | 17.2 | 0.99 |
