...
We now provide a [`SEQUENCE` generator](https://docs.kuzudb.com/cypher/data-definition/create-sequence) as part of the DDL
that auto-generates sequences of numbers. The range and
step can be customized via optional parameters specified using the `CREATE SEQUENCE` command in the DDL.
