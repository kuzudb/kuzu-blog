...
Kuzu's graph algorithms extension a try, and check out the [docs](https://docs.kuzudb.com/extensions/algos) here.
...
You can find more details on setting up the APOC extension in Neo4j [here](https://docs.kuzudb.com/extensions/neo4j#set-up-neo4j-apoc-extension).
...
You can use Kuzu's [Java API](https://docs.kuzudb.com/system-requirements/#java), which works directly with Android Studio projects.
